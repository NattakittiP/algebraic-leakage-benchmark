"""shap_analysis.py — SHAP-based feature attribution analysis (clean vs leaky model)."""
...
def compute_shap_values(
    ...
    # Normalise to 2-D (n_samples, n_features) for positive class.
    # SHAP ≥ 0.40 may return list [neg, pos] (old API), 3-D (new API), or 2-D.
