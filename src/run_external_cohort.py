"""
run_external_cohort.py — One-file runner for both external cohort audits.

Run from the project root directory:

    python run_external_cohort.py

Optional flags:
    --quick          5 seeds instead of 30 (smoke test, ~10 min)
    --skip_eicu48    Skip the 48h label (saves ~half of eICU runtime)
    --eicu_only      Run eICU only
    --mimic_only     Run MIMIC only
    --n_seeds N      Override number of seeds (default: 30)
    --n_folds N      Override number of CV folds (default: 5)
"""
