...
__all__ = [
    "compute_auc",
    "compute_pr_auc",
    "compute_auc_inflation",
    "compute_attribution_distortion",
    "compute_false_attribution_rate",
    "compute_dca",
]
...
def compute_auc_inflation(
    ...
    Positive values indicate artificial performance boost due to leakage.
    """
...
def compute_attribution_distortion(
    ...
    for feat in all_features:
        ...
        distortion[feat] = int(r_clean - r_leaky)
