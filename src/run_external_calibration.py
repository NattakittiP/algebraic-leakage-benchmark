"""Calibration analysis for external real-world leakage audits (eICU 24h and MIMIC-IV)."""
...
def plot_calibration_summary_figure(df_results: pd.DataFrame, figdir: Path) -> None:
    """Two-row figure: ECE and calibration slope by cohort × pipeline × model."""
